...
public class XSSFReader {
    ...
    public static final List<Student> readStudents(String filePath) throws IOException {
    ...
    public static final List<University> readUniversity(String filePath) throws IOException {
